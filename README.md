...
- `mis/kernel/HuggingfaceSyncBridgeKernel.mis`
...
```bash
bin/misc mis/kernel/HuggingfaceSyncBridgeKernel.mis --check --compact-letters
find mis -name '*.mis' -print0 | xargs -0 -n1 bin/misc --check --compact-letters
```

## Org

[clarity-fintech/huggingface-sync-bridge](https://github.com/clarity-fintech/huggingface-sync-bridge)
